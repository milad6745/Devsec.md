...
🔹 **Trivy** یک ابزار امنیتی متن‌باز هست که برای اسکن کردن کانتینرها، تصاویر داکر، ریپازیتوری‌های Git، سیستم‌عامل‌ها و حتی فایل‌های کانفیگ (مثل Kubernetes و Terraform) استفاده میشه.
